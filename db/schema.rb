...
ActiveRecord::Schema.define(version: 2021_02_31_104760) do
  ...
  create_table "buys", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.bigint "product_purchase_history_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_purchase_history_id"], name: "index_buys_on_product_purchase_history_id"
  end
  ...
  create_table "product_purchase_histories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_product_purchase_histories_on_item_id"
